...
**Rise In requirement:** The project's Twitter profile + project-related posts; 30+ new users onboarded; more advanced features than Level 5; **Stellar Mainnet launch**; real mainnet users (at least 10); security review/audit; real ecosystem adoption.
...
- 30+ onboarding + Twitter/social share: shareable badge cards that name co-signers, deep link, on-chain referral attribution. **AC:** 10+ mainnet users with real tx, referral attribution tracked.
